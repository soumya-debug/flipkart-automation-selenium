...
public class FlipkartLazyLoadingTest {
    ...
    @Test(priority = 1, enabled = true, description = "Verify the flipkart hoomepage load time", groups = {"regression"})
    ...
    @Test(priority = 2, enabled = true, description = "Verify the functionality of search product in mobile category", groups = {"regression"})
...
//		homePage.searchForProduct(product, "Mobile");
    ...
    @Test(priority = 3, enabled = true, description = "Verify the functionality of image loading and visibility", groups = {"regression"})
    ...
    @Test(priority = 4, enabled = true, description = "Verify the flipkart hoomepage load time", groups = {"regression"})
    ...
    @Test(priority = 5, enabled = true, description = "Verify the lazy loading functionality", groups = {"regression"})
    ...
    @Test(priority = 6, enabled = true, description = "Verify the funcitonality of navigating to bottom", groups = {"regression"})
    ...
    @Test(priority = 7, enabled = true, description = "Verify the functionality of cross browser and screen resolution", groups = {"regression"})
